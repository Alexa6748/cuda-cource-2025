...
class RetinaNetCalibrator(trt.IInt8EntropyCalibrator2):
    def __init__(self, cache_file="retinanet_mobilenet_int8_raw_transferred_weights.cache", calib_batch_size=8, calib_images_dir=None):
...
def build_int8_engine(onnx_path: str, engine_path: str, calib_images_dir: str):
    ...
    calibrator = RetinaNetCalibrator(
        cache_file="retinanet_mobilenet_int8_raw_transferred_weights.cache",
        calib_batch_size=8,
...
if __name__ == "__main__":
    onnx_path = "models/retinanet_mobilenet_int8_transferred_weights.onnx"
    engine_path = "models/retinanet_mobilenet_int8_raw_transferred_weights.trt"
