...
### Результаты после использования texture memory для входного изображения:
<img width="900" height="538" alt="image" src="https://github.com/user-attachments/assets/75ece64d-e248-4a04-a77e-c9bfb2d5a2a4" />
<br>

| Изображение         | Размер       | Время ядра (мс) |
|---------------------|-------------|------------------|
| House.bmp           | 256 × 256    | 0.09            |
| otpusk.pgm          | 260 × 194    | 0.10            |
| Tiffany.bmp         | 512 × 512    | 0.11            |
| cat.bmp             | 728 × 782    | 0.08            |
| wallpaper.bmp       | 1920 × 1080  | 0.11            |
...
- Использование текстур лучше заметно на больших разрешениях благодаря оптимизации 2D-кэширования соседних пикселей
